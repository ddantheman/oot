...
Gfx mat_my_dungeon_room_2_dl_floor_2_layerOpaque[] = {
	gsSPLoadGeometryMode(G_SHADE | G_CULL_BACK | G_ZBUFFER | G_SHADING_SMOOTH | G_FOG),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, 1, COMBINED, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED),
	gsSPSetOtherMode(G_SETOTHERMODE_H, 4, 20, G_TC_FILT | G_AD_NOISE | G_CK_NONE | G_TT_RGBA16 | G_CD_MAGICSQ | G_TF_BILERP | G_PM_NPRIMITIVE | G_TL_TILE | G_TD_CLAMP | G_TP_PERSP | G_CYC_2CYCLE),
...
Gfx mat_my_dungeon_room_2_dl_oot_water_mat_layerTransparent[] = {
	gsSPLoadGeometryMode(G_LIGHTING | G_SHADE | G_ZBUFFER | G_SHADING_SMOOTH | G_FOG),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL1, TEXEL0, ENV_ALPHA, TEXEL0, 0, 0, 0, 1, COMBINED, 0, SHADE, 0, COMBINED, 0, PRIMITIVE, 0),
	gsSPSetOtherMode(G_SETOTHERMODE_H, 4, 20, G_TC_FILT | G_AD_NOISE | G_CK_NONE | G_CD_MAGICSQ | G_TF_BILERP | G_TT_NONE | G_PM_NPRIMITIVE | G_TL_TILE | G_TD_CLAMP | G_TP_PERSP | G_CYC_2CYCLE),
	gsSPSetOtherMode(G_SETOTHERMODE_L, 0, 32, G_RM_AA_ZB_XLU_SURF2 | G_ZS_PIXEL | G_AC_NONE | G_RM_FOG_SHADE_A),
	gsSPTexture(65535, 65535, 0, 0, 1),
