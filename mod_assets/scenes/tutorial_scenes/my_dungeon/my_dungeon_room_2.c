...
Gfx mat_my_dungeon_room_2_dl_floor_2_layerOpaque[] = {
	gsSPLoadGeometryMode(G_SHADE | G_ZBUFFER | G_FOG | G_SHADING_SMOOTH | G_CULL_BACK),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, 1, COMBINED, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED),
	gsSPSetOtherMode(G_SETOTHERMODE_H, 4, 20, G_TF_BILERP | G_TL_TILE | G_TD_CLAMP | G_CYC_2CYCLE | G_CD_MAGICSQ | G_TC_FILT | G_TT_RGBA16 | G_AD_NOISE | G_TP_PERSP | G_PM_NPRIMITIVE | G_CK_NONE),
...
Gfx mat_my_dungeon_room_2_dl_oot_water_mat_layerTransparent[] = {
	gsSPLoadGeometryMode(G_SHADE | G_ZBUFFER | G_LIGHTING | G_FOG | G_SHADING_SMOOTH),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL1, TEXEL0, ENV_ALPHA, TEXEL0, 0, 0, 0, 1, COMBINED, 0, SHADE, 0, COMBINED, 0, PRIMITIVE, 0),
	gsSPSetOtherMode(G_SETOTHERMODE_H, 4, 20, G_TF_BILERP | G_TL_TILE | G_TT_NONE | G_TD_CLAMP | G_CYC_2CYCLE | G_CD_MAGICSQ | G_TC_FILT | G_AD_NOISE | G_TP_PERSP | G_PM_NPRIMITIVE | G_CK_NONE),
	gsSPSetOtherMode(G_SETOTHERMODE_L, 0, 32, G_RM_FOG_SHADE_A | G_AC_NONE | G_RM_AA_ZB_XLU_SURF2 | G_ZS_PIXEL),
	gsSPTexture(65535, 65535, 0, 0, 1),
